...
par(mfrow = c(2, 2))
plot(x = datetime, y = selected_data$Global_active_power, ylab = "Global Active Power", type = "l", xlab = "")
plot(x = datetime, y = selected_data$Voltage, ylab = "Voltage", type = "l", xlab = "datetime")
...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, lwd = 2, cex = 0.5, bty = "n")
plot(x = datetime, y = selected_data$Global_reactive_power, ylab = "Global_reactive_power", type = "l", xlab = "datetime")

## copying the plots to png file
